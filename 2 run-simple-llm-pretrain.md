...
由于训练的复杂度，我们没有一上来就训练一个GPT-2规模的大模型，而是从一个小的大语言模型学习预训练，这是一个起英文名字的大模型，来自于大神 karpathy （ https://gist.github.com/karpathy/8627fe009c40f57531cb18360106ce95 ）。
...
我们将这段代码作为理解 Transformer 训练逻辑的最佳切片，下面我们按照逻辑板块进行逐行深度解读：
